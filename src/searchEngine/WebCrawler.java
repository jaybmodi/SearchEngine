...
public class WebCrawler 
{
	...
	public static void createFile(String title,String text,String link) 
	{
		try {
			...
			File f = new File("convertedWebPages//"+newTitle+".txt");            // create text file in convertedWebPages folder
			f.createNewFile();			
	...
	public static void main(String[] args) {
		String links="https://www.apple.com/ca/";   //crawls the  mentioned link
		crawlPages(links);
	}
}
